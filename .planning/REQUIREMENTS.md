...
- [ ] **CORE-03**: 사용자가 벤치마킹 채널의 인기 영상 자막을 수집(조회수 높은 순 5~10개)하고 데이터로 저장할 수 있다

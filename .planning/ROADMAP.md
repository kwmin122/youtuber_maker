...
- [ ] **Phase 5: Video Assembly** - 자막 편집, 트랜지션, 효과음/BGM, 미리보기, MP4 내보내기
...
**Success Criteria** (what must be TRUE):
  ...
  3. 사용자가 인기 영상의 자막을 수집 버튼으로 일괄 수집하고, 수집된 자막 데이터를 확인할 수 있다
**Plans**: TBD
**UI hint**: yes
...
**Goal**: 생성된 미디어 에셋을 조합하여 자막/트랜지션/효과음이 포함된 완성 쇼츠를 미리보고 MP4로 내보낸다
**Depends on**: Phase 4
...
| 5. Video Assembly | 0/TBD | Not started | - |
